    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/shop/sportswear/women" className="bg-falco-accent text-black px-6 py-3 rounded-full font-bold hover:bg-falco-gold transition-colors duration-300">
            Back to Women's Sportswear
          </Link>
        </div>
      </div>
    )
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/shop/sportswear/women" className="flex items-center space-x-2 text-white hover:text-falco-accent transition-colors duration-300">
              <ArrowLeft className="w-5 h-5" />
              <span className="font-semibold">Back to Women's Sportswear</span>
            </Link>
