...
import { ArrowLeft, Shirt, Zap } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="relative pt-20 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-600/5 via-transparent to-green-800/5"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">
              <span className="gradient-text">Sportswear</span> Collection
            </h1>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto mb-8">
              Premium athletic apparel for performance and style
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <Zap className="w-6 h-6 text-green-500 mx-4" />
            <div className="h-px bg-gradient-to-r from-transparent via-green-500 to-transparent w-32"></div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Sportswear Products</h2>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">Comfort meets performance</p>
        </div>
